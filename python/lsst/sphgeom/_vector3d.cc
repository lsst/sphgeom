...
void defineClass(nb::class_<Vector3d> &cls) {
    ...
    cls.def("__add__", &Vector3d::operator+, nb::is_operator());
    cls.def("__sub__",
            (Vector3d(Vector3d::*)(Vector3d const &) const) &
                    Vector3d::operator-,
            nb::is_operator());
    cls.def("__mul__", &Vector3d::operator*, nb::is_operator());
    cls.def("__truediv__", &Vector3d::operator/, nb::is_operator());
    ...
    cls.def("__len__", [](Vector3d const &self) { return nb::int_(3); });
    cls.def("__getitem__", [](Vector3d const &self, nb::int_ i) {
