...
PYBIND11_PLUGIN(sphgeom) {
    ...
    py::class_<Region, std::shared_ptr<Region>> region(mod, "Region");
    py::class_<Box, std::shared_ptr<Box>, Region> box(mod, "Box");
    py::class_<Circle, std::shared_ptr<Circle>, Region> circle(mod, "Circle");
    py::class_<ConvexPolygon, std::shared_ptr<ConvexPolygon>, Region>
            convexPolygon(mod, "ConvexPolygon");
    py::class_<Ellipse, std::shared_ptr<Ellipse>, Region> ellipse(mod,
                                                                  "Ellipse");
